...
```{r}
saveRDS(htx.sample_data, file.path(basepath, 'tmp/htx.sample_data.Rds'))
saveRDS(cts, file.path(basepath, 'tmp/cts.Rds'))
saveRDS(res1, file.path(basepath, 'tmp/res1.Rds'))
saveRDS(res2, file.path(basepath, 'tmp/res2.Rds'))
saveRDS(res1df, file.path(basepath, 'tmp/res1df.Rds'))
saveRDS(res2df, file.path(basepath, 'tmp/res2df.Rds'))
